    ...
    <div style={{ background: C.offwhite, minHeight: "100vh" }}>
      ...
      <nav style={{ position: "sticky", top: 0, zIndex: 100, background: "rgba(250,248,245,0.97)", backdropFilter: "blur(16px)", borderBottom: "1px solid rgba(0,0,0,0.04)", padding: "0 20px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 54 }}>
          ...
          <a href="https://wa.me/6580576702?text=Hi%20QuickFund%2C%20interested%20in%20partnership" target="_blank" rel="noopener" style={{ fontFamily: "Syne, sans-serif", fontSize: 11, fontWeight: 700, color: "#fff", background: C.orange, padding: "7px 14px", borderRadius: 6, textDecoration: "none" }}>Become a Partner</a>
        </div>
      </nav>

      {/* Hero */}
      <section style={{ padding: "60px 20px 40px", maxWidth: 900, margin: "0 auto" }}>
        <div style={{ fontFamily: "Syne, sans-serif", fontSize: 10, fontWeight: 800, color: C.orange, letterSpacing: "2px", textTransform: "uppercase", marginBottom: 12 }}>Referral Partners</div>
        <h1 style={{ fontFamily: "Syne, sans-serif", fontSize: 38, fontWeight: 800, color: C.black, lineHeight: 0.95, letterSpacing: "-2px", marginBottom: 16 }}>
        ...
        <a href="https://wa.me/6580576702?text=Hi%20QuickFund%2C%20interested%20in%20becoming%20a%20referral%20partner" target="_blank" rel="noopener" style={{ fontFamily: "Syne, sans-serif", fontSize: 14, fontWeight: 700, color: "#fff", background: C.black, padding: "13px 28px", borderRadius: 8, textDecoration: "none", display: "inline-block" }}>Let's Talk</a>
      </section>

      {/* How it works */}
      <section style={{ padding: "40px 20px 50px", maxWidth: 900, margin: "0 auto" }}>
        <h2 style={{ fontFamily: "Syne, sans-serif", fontSize: 22, fontWeight: 800, color: C.black, marginBottom: 24 }}>How it works</h2>
        <div className="qf-partner-steps" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 3 }}>
          {[
            ...
            <div key={i} style={{ background: i % 2 === 0 ? "#fff" : C.cream, padding: "24px 20px", borderRadius: 2 }}>
              <span style={{ fontFamily: "Syne, sans-serif", fontSize: 36, fontWeight: 800, color: `${C.orange}20`, lineHeight: 1, display: "block", marginBottom: 12 }}>{step.n}</span>
              <h3 style={{ fontFamily: "Syne, sans-serif", fontSize: 15, fontWeight: 800, color: C.black, marginBottom: 6 }}>{step.t}</h3>
      ...
      <section style={{ padding: "0 20px 50px", maxWidth: 900, margin: "0 auto" }}>
        <div className="qf-partner-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 3 }}>
          <div style={{ background: C.black, padding: "32px 28px", borderRadius: 2 }}>
            <h2 style={{ fontFamily: "Syne, sans-serif", fontSize: 20, fontWeight: 800, color: "#fff", marginBottom: 10 }}>You refer to us</h2>
          ...
          <div style={{ background: "#fff", padding: "32px 28px", borderRadius: 2 }}>
            <h2 style={{ fontFamily: "Syne, sans-serif", fontSize: 20, fontWeight: 800, color: C.black, marginBottom: 10 }}>We refer to you</h2>
      ...
      {/* Who we partner with */}
      <section style={{ padding: "0 20px 50px", maxWidth: 900, margin: "0 auto" }}>
        <h2 style={{ fontFamily: "Syne, sans-serif", fontSize: 22, fontWeight: 800, color: C.black, marginBottom: 20 }}>Who we partner with</h2>
      ...
      <section style={{ padding: "0 20px 50px", maxWidth: 900, margin: "0 auto" }}>
        <div style={{ background: C.cream, borderRadius: 12, padding: "32px 28px", borderLeft: `3px solid ${C.orange}` }}>
          <h2 style={{ fontFamily: "Syne, sans-serif", fontSize: 20, fontWeight: 800, color: C.black, marginBottom: 12 }}>Your reputation is safe with us</h2>
          ...
          <p style={{ fontFamily: "Figtree, sans-serif", fontSize: 15, color: C.grey, lineHeight: 1.7, marginBottom: 12 }}>
            If a loan isn't right for your client, we'll say so. We'd rather protect your relationship than force a deal. Read our <a href="https://quickfund.sg/responsible-business-promise" style={{ color: C.orange, textDecoration: "none", fontWeight: 500 }}>Responsible Business Promise</a> to see how we operate.
          </p>
      ...
      <section style={{ padding: "0 20px 50px", maxWidth: 900, margin: "0 auto" }}>
        <h2 style={{ fontFamily: "Syne, sans-serif", fontSize: 22, fontWeight: 800, color: C.black, marginBottom: 12 }}>Tools you can share with your clients</h2>
        ...
        <div className="qf-partner-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
          {[
            ...
            <div key={i} style={{ padding: "20px 18px", background: "#fff", borderRadius: 8, border: `1px solid ${C.greyLight}` }}>
              ...
              <h3 style={{ fontFamily: "Syne, sans-serif", fontSize: 14, fontWeight: 700, color: C.black, marginBottom: 4 }}>{tool.t}</h3>
      ...
      {/* Partner FAQ */}
      <section style={{ padding: "0 20px 50px", maxWidth: 900, margin: "0 auto" }}>
        <h2 style={{ fontFamily: "Syne, sans-serif", fontSize: 22, fontWeight: 800, color: C.black, marginBottom: 16 }}>Partner FAQ</h2>
      ...
      <section style={{ padding: "0 20px 60px", maxWidth: 900, margin: "0 auto" }}>
        <div style={{ background: C.black, borderRadius: 12, padding: "36px 32px", textAlign: "center" }}>
          <h2 style={{ fontFamily: "Syne, sans-serif", fontSize: 22, fontWeight: 800, color: "#fff", marginBottom: 8 }}>Interested?</h2>
          ...
          <a href="https://wa.me/6580576702?text=Hi%20QuickFund%2C%20interested%20in%20becoming%20a%20referral%20partner" target="_blank" rel="noopener" style={{ padding: "13px 32px", background: C.orange, color: "#fff", borderRadius: 8, fontFamily: "Syne, sans-serif", fontSize: 14, fontWeight: 700, textDecoration: "none" }}>WhatsApp Us</a>
        </div>
      </section>
      ...
      <footer style={{ padding: "24px 20px", maxWidth: 900, margin: "0 auto", borderTop: `1px solid ${C.greyLight}` }}>
        <div style={{ padding: "14px 16px", background: C.cream, borderRadius: 8, marginBottom: 16 }}>
          <p style={{ fontFamily: "Figtree, sans-serif", fontSize: 10, color: C.grey, lineHeight: 1.6, margin: 0 }}>
            <span style={{ fontWeight: 600, color: C.black }}>Disclaimer:</span> QuickFund Pte Ltd is part of the Levara Advisory Group. This page is for general informational purposes only. QuickFund does not provide regulated financial, legal, tax or investment advice. Partnership terms, referral fees, and arrangements are subject to individual agreement. All financing decisions are made solely by the end client.
          </p>
        </div>
