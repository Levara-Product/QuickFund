...
const SECTIONS = [
  ...
  { title: "Regulatory and Legal", items: [
    ...
    { q: "Are you licensed?", a: "QuickFund is a registered Singapore company and part of the Levara Advisory Group. We are not a licensed financial adviser and do not provide regulated financial, legal, tax or investment advice. For securities, equity, convertible, fund-raising or capital-markets transactions, we work with appropriately licensed or specialist parties where required." },
  ...
  return (
    <div style={{ background: C.offwhite, minHeight: "100vh" }}>
      ...
      <section style={{ padding: "60px 20px 32px", maxWidth: 900, margin: "0 auto" }}>
        <div style={{ fontFamily: "Syne, sans-serif", fontSize: 10, fontWeight: 800, color: C.orange, letterSpacing: "2px", textTransform: "uppercase", marginBottom: 12 }}>FAQ</div>
        <h1 style={{ fontFamily: "Syne, sans-serif", fontSize: 36, fontWeight: 800, color: C.black, lineHeight: 0.95, letterSpacing: "-2px", marginBottom: 12 }}>
          ...
          <div>
            {SECTIONS.map(section => (
              <div key={section.title} id={`faq-${section.title}`} style={{ marginBottom: 32 }}>
                <h2 style={{ fontFamily: "Syne, sans-serif", fontSize: 18, fontWeight: 800, color: C.black, marginBottom: 12, paddingTop: 8 }}>{section.title}</h2>
      ...
      <section style={{ padding: "0 20px 60px", maxWidth: 900, margin: "0 auto" }}>
        <div style={{ background: C.black, borderRadius: 12, padding: "36px 32px", textAlign: "center" }}>
          <h2 style={{ fontFamily: "Syne, sans-serif", fontSize: 22, fontWeight: 800, color: "#fff", marginBottom: 8 }}>Still have questions?</h2>
          ...
          <a href="https://wa.me/6580576702?text=Hi%20QuickFund%2C%20I%20have%20a%20question" target="_blank" rel="noopener" style={{ padding: "12px 28px", background: C.orange, color: "#fff", borderRadius: 8, fontFamily: "Syne, sans-serif", fontSize: 14, fontWeight: 700, textDecoration: "none" }}>WhatsApp Us</a>
        </div>
      </section>
