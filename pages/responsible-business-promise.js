...
export default function ResponsiblePromise() {
  const Section = ({ children, style = {} }) => (
    <div style={{ maxWidth: 680, margin: "0 auto", padding: "0 20px", ...style }}>{children}</div>
  );
  const H2 = ({ children }) => (
    <h2 style={{ fontFamily: "Syne, sans-serif", fontSize: 22, fontWeight: 800, color: C.black, lineHeight: 1.1, letterSpacing: "-1px", marginBottom: 14 }}>{children}</h2>
  );
    ...
    <div style={{ background: C.offwhite, minHeight: "100vh" }}>
      ...
      <nav style={{ position: "sticky", top: 0, zIndex: 100, background: "rgba(250,248,245,0.97)", backdropFilter: "blur(16px)", borderBottom: "1px solid rgba(0,0,0,0.04)", padding: "0 20px" }}>
        <div style={{ maxWidth: 680, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 54 }}>
          ...
          <a href="https://wa.me/6580576702?text=Hi%20QuickFund" target="_blank" rel="noopener" style={{ fontFamily: "Syne, sans-serif", fontSize: 11, fontWeight: 700, color: "#fff", background: C.black, padding: "7px 14px", borderRadius: 6, textDecoration: "none" }}>WhatsApp</a>
        </div>
      </nav>
      ...
      <section style={{ padding: "60px 20px 40px" }}>
        <Section>
          ...
          <h1 style={{ fontFamily: "Syne, sans-serif", fontSize: 38, fontWeight: 800, color: C.black, lineHeight: 0.95, letterSpacing: "-2px", marginBottom: 20 }}>
      ...
      <article style={{ padding: "0 20px 60px" }}>
        <Section>
          <div style={{ height: 1, background: C.greyLight, margin: "20px 0 32px" }} />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 20 }}>
            {[
              ...
              <div key={i} style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
                <span style={{ fontFamily: "Syne, sans-serif", fontSize: 14, color: C.orange, fontWeight: 800, minWidth: 20 }}>{i + 1}.</span>
          ...
          <div style={{ marginTop: 40, padding: "28px 24px", background: C.black, borderRadius: 12, textAlign: "center" }}>
            <p style={{ fontFamily: "Syne, sans-serif", fontSize: 16, fontWeight: 800, color: "#fff", marginBottom: 8 }}>Ready to work with someone who operates this way?</p>
            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "center", flexWrap: "wrap" }}>
              <a href="https://wa.me/6580576702?text=Hi%20QuickFund" target="_blank" rel="noopener" style={{ padding: "12px 28px", background: C.orange, color: "#fff", borderRadius: 8, fontFamily: "Syne, sans-serif", fontSize: 14, fontWeight: 700, textDecoration: "none" }}>WhatsApp Us</a>
              <a href="https://quickfund.sg/#tools" style={{ padding: "12px 28px", background: "transparent", color: "rgba(255,255,255,0.5)", border: "1.5px solid rgba(255,255,255,0.12)", borderRadius: 8, fontFamily: "Syne, sans-serif", fontSize: 14, fontWeight: 700, textDecoration: "none" }}>Try the AI Tools</a>
            </div>
          </div>
        </Section>
      </article>
      ...
      <footer style={{ padding: "28px 20px", maxWidth: 680, margin: "0 auto", borderTop: `1px solid ${C.greyLight}` }}>
        <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
          <Bolt size={12} />
          <span style={{ fontFamily: "Syne, sans-serif", fontSize: 11, fontWeight: 800, color: C.black, textTransform: "uppercase" }}>QuickFund</span>
          <span style={{ fontFamily: "Figtree, sans-serif", fontSize: 11, color: C.greyLight, marginLeft: 4 }}>Part of Levara Advisory Group</span>
        </div>
        <p style={{ fontFamily: "Figtree, sans-serif", fontSize: 10, color: "rgba(0,0,0,0.2)", lineHeight: 1.4 }}>
          QuickFund Pte Ltd is part of the Levara Advisory Group. This page is a statement of intent, not a contractual obligation. All financing decisions remain solely with the client.
        </p>
      </footer>
    </div>
  );
