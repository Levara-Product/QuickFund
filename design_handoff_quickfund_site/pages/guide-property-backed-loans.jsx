      ...
      <section style={{ padding: "60px 20px 40px" }}>
        <Section>
          ...
          <div style={{ display: "flex", gap: 10, marginTop: 20, flexWrap: "wrap" }}>
            ...
            <a href="https://quickfund.sg/#tools" style={{ fontFamily: "Poppins, sans-serif", fontSize: 13, fontWeight: 700, color: C.black, padding: "12px 24px", borderRadius: 8, border: `1.5px solid ${C.greyLight}`, textDecoration: "none" }}>
        ...
        <Section>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
            {["Doctors and Dentists", "Trading Companies", "Tech Companies", "Startups", "E-commerce", "Software", "F&B", "Construction", "Logistics", "Professional Services", "Retail"].map((s, i) => (
              <a key={i} href={`https://quickfund.sg/guide/${GUIDE_SLUGS[s]}`} style={{
