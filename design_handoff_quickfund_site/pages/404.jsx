...
function NotFound() {
  return (
    <div style={{ background: C.offwhite, minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@700;800&family=Figtree:wght@400;500&display=swap" rel="stylesheet" />
      ...
      <div style={{ display: "flex", gap: 10, flexWrap: "wrap", justifyContent: "center" }}>
        <a href="https://quickfund.sg" style={{ fontFamily: "Poppins, sans-serif", fontSize: 13, fontWeight: 700, color: "#fff", background: C.black, padding: "12px 24px", borderRadius: 8, textDecoration: "none" }}>Back to Home</a>
        <a href="https://quickfund.sg/#tools" style={{ fontFamily: "Poppins, sans-serif", fontSize: 13, fontWeight: 700, color: C.black, padding: "12px 24px", borderRadius: 8, textDecoration: "none", border: `1.5px solid ${C.greyLight}` }}>Try the AI Tools</a>
