    ...
    <div style={{ background: C.offwhite, minHeight: "100vh" }}>
      ...
      <article style={{ padding: "0 20px 60px" }}>
        <Section>
          ...
          <H2>We give you straight answers</H2>
          <P>
          ...
          <P>
            No lender has equity in our business. We are not a subsidiary, affiliate, or captive distribution channel of any lending institution. No lender directs which options we put in front of you.
          </P>
          <P>
          ...
          <H2>We look at the full cost, not just the headline rate</H2>
          <P>
            Interest rates are not the whole picture. Processing fees, commitment fees, valuation costs, legal fees, exit penalties, annual review charges, and hidden clauses all affect what you actually pay. We walk through the total cost of a facility as we see it, not just the headline number — and we encourage you to verify every number independently before you commit.
          </P>
          <P>
            We also flag the non-financial costs worth understanding: personal guarantees and what they expose you to, share charges and what they mean for control of your company, restrictive covenants and how they limit your future options, and cross-default clauses that link unrelated facilities.
          </P>

          <div style={{ height: 1, background: C.greyLight, margin: "32px 0" }} />

          <H2>We actually read term sheets</H2>
          <P>
            Most borrowers accept the first offer they receive without reading past the interest rate and the amount. We read term sheets line by line. We flag clauses that matter. We explain what each provision means in plain language. We negotiate where we can. A second pair of eyes is not legal advice, though — have your own lawyer review any facility agreement before you sign.
          </P>
          <P>
          ...
          <H2>Your information stays confidential</H2>
          <P>
            Your financial information is sensitive. We share your financials, bank statements, personal details, and application materials only with lenders we are jointly approaching with your knowledge, with service providers who help us operate under confidentiality obligations, or where the law requires disclosure. We don't discuss your situation with other clients, referral partners, or competitors. The full details are in our Privacy Policy.
          </P>

          <div style={{ height: 1, background: C.greyLight, margin: "32px 0" }} />

          <H2>No upfront fees for financing introductions</H2>
          <P>
          ...
          <P>
            For advisory work such as debt restructuring, capital stack review, or strategy consulting, we charge a small upfront engagement fee. This is agreed with you in writing before any work begins.
          </P>
          ...
          <P>
            Where we keep working together, we keep an eye on your facilities and the market, flag refinancing windows we spot, and negotiate renewal terms alongside you — helping you bring your cost of capital down over time. This is what a long-term partnership looks like.
          </P>

          <div style={{ height: 1, background: C.greyLight, margin: "32px 0" }} />

          <H2>We operate with integrity</H2>
          <P>
          ...
          <P>
            We make representations to lenders about your situation in good faith, and we pass lender terms on to you as stated. Our client-side fees are agreed with you in writing before we begin work. Where applicable, we may also receive fees from lenders for successful introductions. We aim to be transparent about client-side fees and relevant commercial arrangements.
          </P>
          <P>
          ...
          <H2>If we're not the right fit, we say so</H2>
          <P>
          ...
          <div style={{ marginTop: 40, padding: "28px 24px", background: C.black, borderRadius: 12, textAlign: "center" }}>
            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "center", flexWrap: "wrap" }}>
              ...
              <a href="/#tools" style={{ padding: "12px 28px", background: "transparent", color: "rgba(255,255,255,0.5)", border: "1.5px solid rgba(255,255,255,0.12)", borderRadius: 8, fontFamily: "Poppins, sans-serif", fontSize: 14, fontWeight: 700, textDecoration: "none" }}>Try the AI Tools</a>
            </div>
          </div>
        </Section>
      </article>
...
export default ResponsiblePromise;
