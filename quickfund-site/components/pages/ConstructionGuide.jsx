    ...
    <div style={{ background: C.offwhite, minHeight: "100vh" }}>
      ...
      <article style={{ padding: "0 20px 60px" }}>
        <Section>
          ...
          <P>For more detail on how LCs, trust receipts, and trade finance structures work, see our <a href="/guide/trading-companies" style={{ color: C.orange, textDecoration: "none", fontWeight: 500 }}>Trading Companies guide</a>.</P>
