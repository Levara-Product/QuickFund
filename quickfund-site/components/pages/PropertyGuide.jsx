  ...
  if (done) return (
    <div onClick={onClose} style={{ position: "fixed", inset: 0, zIndex: 200, background: "rgba(0,0,0,0.5)", backdropFilter: "blur(8px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      <div onClick={e => e.stopPropagation()} style={{ background: C.offwhite, borderRadius: 14, padding: 32, maxWidth: 380, width: "100%", textAlign: "center" }}>
        ...
        <h3 style={{ fontFamily: "Poppins, sans-serif", fontSize: 18, fontWeight: 800, color: C.black, marginBottom: 6 }}>On its way.</h3>
        <p style={{ fontFamily: "Figtree, sans-serif", fontSize: 13, color: C.grey }}>Your property investor guide is coming via {method === "whatsapp" ? "WhatsApp" : "email"} — our team sends it personally, usually within one working day.</p>
  ...
  return (
    <div onClick={onClose} style={{ position: "fixed", inset: 0, zIndex: 200, background: "rgba(0,0,0,0.5)", backdropFilter: "blur(8px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 20, animation: "fadeIn 0.2s ease" }}>
      <div onClick={e => e.stopPropagation()} style={{ background: C.offwhite, borderRadius: 14, padding: "28px 26px", maxWidth: 400, width: "100%", position: "relative" }}>
        ...
        <h3 style={{ fontFamily: "Poppins, sans-serif", fontSize: 20, fontWeight: 800, color: C.black, lineHeight: 1.15, marginBottom: 8 }}>Property Investor<br />Financing Guide</h3>
...
function PropertyGuide() {
  ...
  const H2 = ({ children }) => (
    <h2 style={{ fontFamily: "Poppins, sans-serif", fontSize: 24, fontWeight: 800, color: C.black, lineHeight: 1.1, letterSpacing:"-0.35px", marginBottom: 14 }}>{children}</h2>
  );
    ...
    <div style={{ background: C.offwhite, minHeight: "100vh" }}>
      ...
      <nav style={{ position: "sticky", top: 0, zIndex: 100, background: "rgba(250,248,245,0.97)", backdropFilter: "blur(16px)", borderBottom: "1px solid rgba(0,0,0,0.04)", padding: "0 20px" }}>
        <div style={{ maxWidth: 720, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 54 }}>
          ...
          <div style={{ display: "flex", gap: 12, alignItems: "center" }} className="qf-guide-nav-btns">
            ...
            <a href="https://wa.me/6580576702?text=Hi%20QuickFund%2C%20question%20about%20property%20financing" target="_blank" rel="noopener" style={{ fontFamily: "Poppins, sans-serif", fontSize: 11, fontWeight: 700, color: "#fff", background: C.black, padding: "7px 14px", borderRadius: 6, textDecoration: "none" }}>WhatsApp</a>
          </div>
        </div>
      </nav>
      ...
      <section style={{ padding: "60px 20px 40px" }}>
        <Section>
          ...
          <div style={{ display: "flex", gap: 10, marginTop: 20, flexWrap: "wrap" }}>
            <a onClick={() => setShowGate(true)} style={{ fontFamily: "Poppins, sans-serif", fontSize: 13, fontWeight: 700, color: "#fff", background: C.orange, padding: "12px 24px", borderRadius: 8, cursor: "pointer", display: "inline-flex", alignItems: "center", gap: 7 }}>
              Download Full Guide <Bolt size={12} color="#fff" />
            </a>
            <a href="/#tools" style={{ fontFamily: "Poppins, sans-serif", fontSize: 13, fontWeight: 700, color: C.black, padding: "12px 24px", borderRadius: 8, border: `1.5px solid ${C.greyLight}`, textDecoration: "none" }}>
      ...
      <article style={{ padding: "0 20px 60px" }}>
        <Section>
          ...
          <h3 style={{ fontFamily: "Poppins, sans-serif", fontSize: 16, fontWeight: 700, color: C.black, marginBottom: 8, marginTop: 20 }}>If it's a rental property, the rental income can help service the loan</h3>
          <P>
          ...
          <h3 style={{ fontFamily: "Poppins, sans-serif", fontSize: 16, fontWeight: 700, color: C.black, marginBottom: 8, marginTop: 20 }}>First charge and share charge</h3>
          <P>
          ...
          <h3 style={{ fontFamily: "Poppins, sans-serif", fontSize: 16, fontWeight: 700, color: C.black, marginBottom: 8, marginTop: 20 }}>Not just property: car refinancing too</h3>
          <P>
          ...
          <div style={{ background: C.black, borderRadius: 12, padding: "28px 24px", marginBottom: 24 }}>
            <div style={{ fontFamily: "Poppins, sans-serif", fontSize: 10, fontWeight: 800, color: C.orange, letterSpacing: "2px", textTransform: "uppercase", marginBottom: 6 }}>
            ...
            <div style={{ marginTop: 32, display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12 }} className="qf-guide-toc">
              {[
                ...
                <div key={i} style={{ padding: "12px", background: "rgba(255,255,255,0.04)", borderRadius: 8 }}>
                  ...
                  <div style={{ fontFamily: "Poppins, sans-serif", fontSize: 14, fontWeight: 800, color: "#fff", marginTop: 2 }}>{ex.value}</div>
                  <div style={{ fontFamily: "Poppins, sans-serif", fontSize: 12, fontWeight: 700, color: C.orange, marginTop: 2 }}>{ex.gain}</div>
                </div>
              ))}
            </div>
          ...
          <div style={{ padding: "20px 22px", background: C.cream, borderRadius: 10, marginBottom: 16, borderLeft: `3px solid ${C.black}` }}>
            <P style={{ margin: 0, fontSize: 14, color: C.black, fontWeight: 500, lineHeight: 1.7 }}>
              At QuickFund, we believe in responsible borrowing. We don't encourage debt you cannot service. Before you consider a property-backed loan, ask yourself:
            </P>
          </div>
          {[
          ...
          {[
            ...
            { t: "Caveat loans", d: "A fast short-term facility where the lender secures its position by lodging a caveat against your property instead of registering a full mortgage. Because there is no full conveyancing process, setup is quicker and cheaper, and funds can disburse in days. The trade-offs: quantum is usually lower, tenors are short (often 1 to 12 months), rates are higher than mortgage-secured lending, and the caveat sits behind any existing mortgagee. Typically offered by non-bank and private lenders. Useful for urgent, short-duration needs where speed matters more than cost, but the exit plan needs to be clear before you sign." },
          ...
          <h3 style={{ fontFamily: "Poppins, sans-serif", fontSize: 16, fontWeight: 700, color: C.black, marginBottom: 8, marginTop: 20 }}>Valuation is not one number</h3>
          <P>
          ...
          <h3 style={{ fontFamily: "Poppins, sans-serif", fontSize: 16, fontWeight: 700, color: C.black, marginBottom: 8, marginTop: 20 }}>Speed vs cost vs quantum</h3>
          <P>
          ...
          <h3 style={{ fontFamily: "Poppins, sans-serif", fontSize: 16, fontWeight: 700, color: C.black, marginBottom: 8, marginTop: 20 }}>Cash flow assessment varies by lender</h3>
          <P>
          ...
          <div style={{ marginTop: 32, display: "flex", flexDirection: "column", gap: 12 }}>
            <a onClick={() => setShowGate(true)} style={{
              ...
              <div>
                <div style={{ fontFamily: "Poppins, sans-serif", fontSize: 14, fontWeight: 700, color: "#fff" }}>Download the full Property Investor Guide</div>
            ...
            <a href="/#tools" style={{
              ...
              <div>
                <div style={{ fontFamily: "Poppins, sans-serif", fontSize: 14, fontWeight: 700, color: C.black }}>Try the AI Loan Check-Up</div>
            ...
            <a href="https://wa.me/6580576702?text=Hi%20QuickFund%2C%20I%20have%20a%20property%20financing%20question" target="_blank" rel="noopener" style={{
              ...
              <div>
                <div style={{ fontFamily: "Poppins, sans-serif", fontSize: 14, fontWeight: 700, color: "#fff" }}>Talk to our team</div>
        ...
        <Section>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
            {["Doctors and Dentists", "Trading Companies", "Tech Companies", "Startups", "E-commerce", "Software", "F&B", "Construction", "Logistics", "Professional Services", "Retail"].map((s, i) => (
              <a key={i} href={`/guide/${GUIDE_SLUGS[s]}`} style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 24 }} className="qf-guide-toc">
            <div>
              ...
              {["Home", "AI Tools", "Partners", "FAQ", "Responsible Business Promise"].map(l => (
                <a key={l} href={`/${l === "Home" ? "" : l === "AI Tools" ? "#tools" : l === "FAQ" ? "#faq" : l.toLowerCase()}`} style={{ display: "block", fontFamily: "Figtree, sans-serif", fontSize: 12, color: "rgba(255,255,255,0.4)", textDecoration: "none", marginBottom: 6 }}>{l}</a>
              ))}
            </div>
            <div>
      ...
      <footer style={{ background: C.black, padding: "0 20px 28px" }}>
        <Section>
          <div style={{ padding: "18px 20px", background: "rgba(255,255,255,0.04)", borderRadius: 8, border: "1px solid rgba(255,255,255,0.06)", marginBottom: 20 }}>
            <p style={{ fontFamily: "Poppins, sans-serif", fontSize: 10, fontWeight: 800, color: "rgba(255,255,255,0.4)", letterSpacing: "1.5px", textTransform: "uppercase", marginBottom: 8 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              ...
              <span style={{ fontFamily: "Poppins, sans-serif", fontSize: 10, fontWeight: 800, color: "rgba(255,255,255,0.3)", textTransform: "uppercase" }}>QuickFund</span>
