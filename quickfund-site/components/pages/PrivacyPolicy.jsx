...
function PrivacyPolicy() {
  ...
  const H2 = ({ children }) => (<h2 style={{ fontFamily: "Poppins, sans-serif", fontSize: 20, fontWeight: 800, color: C.black, lineHeight: 1.1, letterSpacing:"0px", marginBottom: 12 }}>{children}</h2>);
    ...
    <div style={{ background: C.offwhite, minHeight: "100vh" }}>
      ...
      <nav style={{ position: "sticky", top: 0, zIndex: 100, background: "rgba(250,248,245,0.97)", backdropFilter: "blur(16px)", borderBottom: "1px solid rgba(0,0,0,0.04)", padding: "0 20px" }}>
        <div style={{ maxWidth: 680, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 54 }}>
          ...
          <a href="https://wa.me/6580576702" target="_blank" rel="noopener" style={{ fontFamily: "Poppins, sans-serif", fontSize: 11, fontWeight: 700, color: "#fff", background: C.black, padding: "7px 14px", borderRadius: 6, textDecoration: "none" }}>WhatsApp</a>
        </div>
      </nav>

      <section style={{ padding: "60px 20px 40px" }}>
        <Section>
          <div style={{ fontFamily: "Poppins, sans-serif", fontSize: 10, fontWeight: 800, color: C.orange, letterSpacing: "2px", textTransform: "uppercase", marginBottom: 12 }}>Legal</div>
          <h1 style={{ fontFamily: "Poppins, sans-serif", fontSize: 36, fontWeight: 800, color: C.black, lineHeight: 0.95, letterSpacing:"-0.8px", marginBottom: 16 }}>Privacy Policy</h1>
      ...
      <article style={{ padding: "0 20px 60px" }}>
        <Section>
          <H2>Who we are</H2>
          <P>QuickFund Pte Ltd ("QuickFund," "we," "us," or "our") is a Singapore-registered company. We operate the website quickfund.sg and related services. This Privacy Policy explains how we collect, use, disclose, and protect your personal data in accordance with the Personal Data Protection Act 2012 ("PDPA") of Singapore.</P>
          ...
          <P>Our website features AI-powered tools (Loan Check-Up, Term Sheet Scanner, Rate Check) that process information you provide to generate assessments. The information you enter into these tools is sent to our servers and processed using third-party AI services. We do not store the AI-generated output permanently. The information you provide (your answers, term sheet content, or rate details) may be stored for the purpose of following up on your enquiry and improving our services.</P>
          ...
          <P>Some tools on this site let you type or paste free text, such as loan terms. Please do not include sensitive personal identifiers (for example NRIC or passport numbers, bank account numbers) or confidential information beyond what the tool asks for. The tools work just as well without them. To the extent permitted by law, any such information you choose to include is submitted at your own risk and QuickFund accepts no responsibility for its inclusion. Whatever we receive, we handle in accordance with this policy and the PDPA.</P>
