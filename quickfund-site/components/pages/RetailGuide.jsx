  ...
  return (
    <div style={{ background: C.offwhite, minHeight: "100vh" }}>
      ...
      <article style={{ padding: "0 20px 60px" }}><Section>
        ...
        <P>Trade finance is most accessible for retailers with established banking relationships and at least 2 to 3 years of import history. If you're newer, non-bank trade finance providers may be an alternative, though the costs will be higher. For more on LC and trust receipt structures, see our <a href="/guide/trading-companies" style={{ color: C.orange, textDecoration: "none", fontWeight: 500 }}>Trading Companies guide</a>.</P>
        ...
        <P>If you or your directors own property in Singapore, property-backed facilities typically offer the strongest financing terms available: lowest rates, highest quantum, longest tenor. For a retail business that needs capital for inventory, fit-out, and a working capital buffer, property equity can fund the entire setup more cost-effectively than any combination of unsecured facilities.</P>
        <P>The trade-off is real: if the retail business fails, the property is at risk. Retail has meaningful failure rates, particularly in the first 2 to 3 years. Before pledging property, stress-test the business plan at 30% below projected revenue and make sure the numbers still work. For more detail, see our <a href="/guide/property-backed-loans" style={{ color: C.orange, textDecoration: "none", fontWeight: 500 }}>Property-Backed Loans guide</a>.</P>
