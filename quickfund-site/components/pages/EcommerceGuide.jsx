    ...
    <div style={{ background: C.offwhite, minHeight: "100vh" }}>
      ...
      <article style={{ padding: "0 20px 60px" }}>
        <Section>
          ...
          <Callout type="dark">
            <P style={{ margin: 0, fontSize: 14, color: C.black, fontWeight: 500, lineHeight: 1.7 }}>Trust receipts carry personal liability. The goods and their proceeds belong to the bank until the TR is settled. If you sell the goods and use the money for something else instead of repaying the bank, you are personally liable. This is not a technicality. For more on LC and TR structures, read our <a href="/guide/trading-companies" style={{ color: C.orange, textDecoration: "none", fontWeight: 600 }}>Trading Companies guide</a>.</P>
          </Callout>
          ...
          <P>For more detail on how property-backed facilities work, including LTV ratios, structures, and what to watch out for, read our <a href="/guide/property-backed-loans" style={{ color: C.orange, textDecoration: "none", fontWeight: 500 }}>Property-Backed Loans guide</a>.</P>
